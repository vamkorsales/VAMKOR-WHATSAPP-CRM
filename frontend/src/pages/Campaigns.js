...
function Campaigns() {
  const [campaigns, setCampaigns] = useState([
    { 
      ...
      dataAdded: 1000, assignedAgent: 'Pratiksha', openTime: '2.5 hrs', language: 'English', approval: 'Approved' 
    },
    { 
      ...
      dataAdded: 5000, assignedAgent: 'Auto-Bot', openTime: '1 hr', language: 'Multi-lingual', approval: 'Pending' 
    },
    { 
      ...
      dataAdded: 320, assignedAgent: 'System', openTime: '30 mins', language: 'Hindi', approval: 'Approved' 
    }
  ]);
  ...
  const handleCreate = () => {
    setCampaigns([...campaigns, {
      id: Date.now(),
      ...formData,
      status: 'Paused', balanceLeft: 0, sent: 0, delivered: 0, opened: 0, replied: 0, failed: 0, dataAdded: 0, assignedAgent: 'Unassigned', openTime: '-', approval: 'Pending'
    }]);
    setOpen(false);
  };
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card elevation={1} sx={{ borderLeft: '4px solid #10B981' }}>
            <CardContent>
              ...
              <Typography variant="h3" fontWeight="bold">{totalSent}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Card elevation={1} sx={{ borderLeft: '4px solid #3B82F6' }}>
            <CardContent>
              ...
              <Typography variant="h3" fontWeight="bold">{totalOpened}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Card elevation={1} sx={{ borderLeft: '4px solid #8B5CF6' }}>
            <CardContent>
              ...
              <Typography variant="h3" fontWeight="bold">1.5 hrs</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Card elevation={1} sx={{ borderLeft: '4px solid #EF4444' }}>
            <CardContent>
              ...
              <Typography variant="h3" fontWeight="bold" color="error">{totalFailed}</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
